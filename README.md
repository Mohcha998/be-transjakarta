...
* Retry connection (DB, RabbitMQ, MQTT)
* Auto reconnect MQTT
* Docker healthcheck
...
* Data masuk MQTT
* Data masuk PostgreSQL
* API berjalan
* RabbitMQ menerima event geofence
...
* Tidak perlu setup manual database (auto migrate)
* Semua service berjalan via Docker
* Tidak perlu install dependency manual
